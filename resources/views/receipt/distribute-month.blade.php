<div class="heading-buttons main-left">
	<div class="buttons pull-left">
		<a href="{{URL}}/receipts/distribute" class="btn btn-small btn-primary btn-icon "><i class="fa fa-plus"></i> Công nợ NCC</a>
		<a href="{{URL}}/receipts/distribute-year" class="btn btn-small btn-primary btn-icon "><i class="fa fa-plus"></i> Công nợ năm NCC</a>
	</div>
	<div class="buttons pull-right">
		<a href="javascript:window.open('{{URL}}/receipts/export-pdf-distribute-month','_blank');" class="btn btn-small btn-primary btn-icon "><i class="fa fa-print"></i> Xuất PDF</a>
		<a href="javascript:window.open('{{URL}}/receipts/export-excel-distribute-month','_blank');" class="btn btn-small btn-primary btn-icon "><i class="fa fa-list"></i> Xuất Excel</a>
	</div>
</div>
		...
		<div class="accordion" id="accordion2" style="margin-bottom: 0;">
			<div class="accordion-group">
				<div class="accordion-heading">
					<a class="accordion-toggle">
						<strong>
							Công nợ nhà cung cấp <span id="date_name"></span>
						</strong>
					</a>
				</div>
				<div id="collapse1" class="accordion-body in collapse" style="height: auto;">
...
<script>
	...
	$(".left-list li").on('click',function(){
		...
		current_year = year;
		$.ajax({
			url : '{{URL}}/receipts/list-receipt-distribute-month',
			type : 'POST',
			data :{
				'month' : month,
				'year' : year
