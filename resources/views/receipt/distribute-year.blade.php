<div class="heading-buttons main-left">
	...
	<div class="buttons pull-right">
		<a href="javascript:window.open('{{URL}}/receipts/export-pdf-distribute-year','_blank');" class="btn btn-small btn-primary btn-icon "><i class="fa fa-print"></i> Xuất PDF</a>
		<a href="javascript:window.open('{{URL}}/receipts/export-excel-distribute-year','_blank');" class="btn btn-small btn-primary btn-icon "><i class="fa fa-list"></i> Xuất Excel</a>
	</div>
</div>
...
<script>
	...
	$(".left-list li").on('click',function(){
		...
		current_year = year;
		$.ajax({
			url : '{{URL}}/receipts/list-receipt-distribute-year',
			type : 'POST',
			data :{
				'year' : year
			},
